 ...
 *
 * Service for formatting AnVIL studies into FE model from ingested data.
 */
 ...
 * @returns {Promise.<*[]>}
 */
const getNCBIStudies = async function getNCBIStudies(workspaces) {
...
async function buildDashboardStudy(gapAccession, workspaces) {
    ...
    const workspacesByStudy = workspaces.filter(workspace => gapAccession === workspace.dbGapIdAccession);
...
module.exports.getNCBIStudies = getNCBIStudies;
