...
**[Section 1:  Concepts](/learn/principal-investigators/setting-up-lab-accounts#concepts)** - The first section provides an overview of the concepts, resources and roles related to billing and account setup.
...
Before working through the setup guide it will be helpful to familiarize yourself with the concepts listed below. Understanding the key concepts will also help you customize your lab setup to your needs.

### Using Terra

**Terra UI** - Familiarize yourself with the Terra user interface. See the guide [Navigating in Terra](https://support.terra.bio/hc/en-us/articles/360022704371-Navigating-in-Terra) for more information.

<hero>For an overview of Terra workspaces, workspace permissions, and general information on billing see [ Getting Started with AnVIL](/learn). </hero>


### Understanding Cloud Costs

<hero>For an overview of cloud costs see [Understanding Cloud Costs](/learn/introduction/understanding-cloud-costs).  </hero>
...
1. **Data Analyst**  - A lab member who is granted write + can-compute access on one or more Terra workspaces by a Lab Manager and who will run analyses in Terra.

1. **Lab Manager** - A lab member who creates one or more Terra Billing Projects for each Data Analyst and configures GCP budgets and alerts. The Lab Manager also creates or clones Terra workspaces and shares them with Data Analysts.

1. **PI** - The individual responsible for paying for cloud costs incurred by data analysts and who sets up the lab’s Google Cloud Account and configures its GCP Billing Account(s) and  Google Payment Method(s). The PI will also add the Lab Manager as a member of the lab’s Google Billing Account(s) to  enable the Lab Manager to create Terra Billing Projects and workspaces for Data Analysts
...
Under this setup, Data Analysts will not be able to create or clone workspaces or download data from workspaces with requester pays buckets, nor will they be able to share workspaces with colleagues. Instead, for data Data Analysts obtain access to the workspaces they require:

1. Data Analysts request a Lab Manager to create or clone the new workspace.
1. The Lab Manager:
   1. Creates a new Terra Billing Project if tracking usage by workspace or decides to use the Data Analyst’s existing Terra Billing Project.
   1.  Sets up budgets and alerts for the new Terra Billing Project or adjusts the budget and alerts for the existing Terra Billing Project if required.
