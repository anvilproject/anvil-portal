...
### Analyzing Data in Tera Workspaces
...
Terra workspaces support interactive analysis with Jupyter notebooks, Bioconductor and Galay. Terra workspaces can also run Docker containerized workflows written in WDL.
...
As mentioned above workspace permissions control if you can read, modify, or launch a workspace cloud environment.
