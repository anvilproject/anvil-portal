...
const AlegreyaSans = () => (
    <Layout>
        <h1 className={classNames(fontStyles.articleHeading, fontStyles.openSans)}>AnVIL: Alegreya Sans</h1>
        <div className={fontStyles.alegreyaSans}>
