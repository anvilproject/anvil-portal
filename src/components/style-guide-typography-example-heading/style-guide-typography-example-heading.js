...
function StyleGuideTypographyExampleHeading(props) {
    ...
    const [styles, setStyles] = useState({marginBottom: "0", paddingBottom: "0"});
    ...
    const MarginBottom = () => {
        ...
        return (
            <span className={compStyles.marginIndicator} style={{height: marginBottom, marginTop: paddingBottom}}>
