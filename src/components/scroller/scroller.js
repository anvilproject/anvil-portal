...
function Scroller(props) {
    ...
    const [containerStyles, setContainerStyles] = useState({maxHeight: `unset`, top: `unset`});
    ...
    const updateContainerStyles = useCallback(() => {
        ...
        setContainerStyles(containerStyles => ({...containerStyles, maxHeight: styles.maxHeight, top: styles.top}));
    ...
    return (
        React.Children.map(children, child => React.cloneElement(child, {style: {maxHeight: maxHeight, top: top}}))
    );
}
