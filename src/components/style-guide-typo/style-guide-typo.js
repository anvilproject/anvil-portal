      ...
      <span className={compStyles.styles}>
        ...
        {showBackgroundColor ? (
          <span className={compStyles.style}>
            <span className={compStyles.label}>Background Color: </span>
            {backgroundColor}
          </span>
        ) : null}
        <span className={compStyles.style}>
          <span className={compStyles.label}>Color: </span>
          {color}
        </span>
        <span className={compStyles.style}>
          <span className={compStyles.label}>Font Size: </span>
          {fontSize}
        </span>
        <span className={compStyles.style}>
          <span className={compStyles.label}>Font Weight: </span>
          {fontWeight}
        </span>
        <span className={compStyles.style}>
          <span className={compStyles.label}>Line Height: </span>
          {lineHeight}
        </span>
        <span className={compStyles.style}>
          <span className={compStyles.label}>Margin: </span>
          {margin}
        </span>
        <span className={compStyles.style}>
          <span className={compStyles.label}>Padding: </span>
          {padding}
        </span>
      </span>
    </>
