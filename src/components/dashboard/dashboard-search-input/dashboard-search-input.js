...
export default () => {
    ...
    const {inputValue, onHandleClearInput, onHandleInput} = useContext(ContextDashboard);

    return (
        <DashboardSearchInput inputValue={inputValue} onHandleClearInput={onHandleClearInput} onHandleInput={(e) => onHandleInput(e)}/>
    )
};
