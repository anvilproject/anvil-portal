        ...
        return (
            ...
            <section className={classNames(compStyles.hero, {[compStyles.handheld]: !isBrowser})}>
                <div className={classNames(globalStyles.grid, globalStyles.g750, globalStyles.centered)}>
                    ...
                    <GoArrow className={goStyles.stretch}><a href="https://anvil.terra.bio/#" rel="noopener noreferrer" target="_blank"><img className={compStyles.logoTerra} src={logoTerra} alt="Terra"/>Launch AnVIL in Terra</a></GoArrow>
                    <Stats/>
                </div>
            </section>
            <Carousel/>
