        ...
        return (
            ...
            <section className={classNames(compStyles.hero, {[compStyles.handheld]: !isBrowser})}>
                <div className={classNames(globalStyles.grid, globalStyles.g750, globalStyles.centered)}>
                    ...
                    <div className={compStyles.linkTerra}><GoArrow><a href="https://anvil.terra.bio/#" target="_blank"><img className={compStyles.logoTerra} src={logoTerra} alt="Terra"/>Launch AnVIL in Terra</a></GoArrow></div>
                    <Stats/>
                </div>
            </section>
            <Carousel/>
