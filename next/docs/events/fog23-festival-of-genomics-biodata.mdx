...
Hear how the NHGRI Genomic Data Science Analysis, Visualization, and Informatics Lab-Space (AnVIL) ([https://anvilproject.org/](https://anvilproject.org/)), is a secure cloud-based platform for genomics and biomedical research. AnVIL currently provides harmonized access to more than 600,000 genomes from several key NHGRI projects along with thousands of analysis tools and workflows. This presentation will introduce the data and analysis capability of AnVIL and discuss the future of biomedical data analysis, sharing, and interoperability.

<Figure
  alt="FOG2023"
  src="/consortia/events/fog23-festival-of-genomics-biodata.png"
/>
