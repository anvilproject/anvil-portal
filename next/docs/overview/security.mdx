...
The NHGRI AnVIL and the data it contains are secured in accordance with the industry best practices, the <Link label="NIST 800-53 Rev 4" url="https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-53r4.pdf"/> security controls at the Moderate baseline, and NIST 800-53 privacy controls documented in Appendix J.
