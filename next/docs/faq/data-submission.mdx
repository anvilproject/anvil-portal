...
5. AnVIL staff will contact you promptly to initiate Data Ingestion. For more information about data transfer and QC, see <Link label="Ingest Data" url="https://anvilproject.org/learn/data-submitters/submission-guide/ingesting-data" /> in the <Link label="Data Submission Guide" url="https://anvilproject.org/learn/data-submitters/submission-guide/data-submitters-overview" />.
...
For more on understanding and controlling cloud costs in AnVIL, see <Link label="Understanding Cloud Costs"url="https://anvilproject.org/learn/introduction/understanding-cloud-costs" />.

For more on preparing a budget justification for cloud costs in AnVIL, see <Link label="Budget Templates" url="https://anvilproject.org/learn/investigators/budget-templates" />.
...
See <Link label="Withdrawing Data from AnVIL" url="https://anvilproject.org/learn/data-submitters/resources/anvil-data-withdrawal-procedures" /> for a description of AnVIL's data withdrawal procedures.
