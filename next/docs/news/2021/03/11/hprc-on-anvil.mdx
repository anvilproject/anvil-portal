...
<Figure alt="HPRC Home" src="/consortia/news/hprc-home.png" />
...
Note that the HPRC Year 1 data is pending publication, currently scheduled for mid-2021. If you would like to publish using this, please contact the HPRC Coordinating Center at [hprcadmin@gowustl.onmicrosoft.com](mailto:hprcadmin@gowustl.onmicrosoft.com).
