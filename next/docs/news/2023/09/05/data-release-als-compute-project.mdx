...
_This project was substantially supported by a [grant from The ALS Association](https://doi.org/10.52546/pc.gr.143413) and was recently awarded a NIH grant (R61NS13060) to further this work. More information can be found in an ALS Association [news article](https://www.als.org/stories-news/transforming-our-understanding-als-association-funded-initiative-pools-thousands)._
