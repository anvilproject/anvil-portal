...
The WDL-based workflows for aligning the samples and analyzing the variants are available at [https://github.com/schatzlab/t2t-chm13-chry](https://github.com/schatzlab/t2t-chm13-chry).
