...
<Subheader>HudsonAlpha: Greg Cooper, PhD, Greg Barsh, PhD, Bruce Korf, PhD</Subheader>

<Image alt="SouthSeq" src="/consortia/cser/projects/images/southseq.png" width={128} />

<p>In "<Link label="South-Seq" url="https://hudsonalpha.org/southseq/" />", we will perform whole-genome sequencing on
  newborns suspected to have genetic disorders and develop and test return of results mechanisms to expand access to
  genetic testing to diverse, especially historically underserved, communities.</p>
