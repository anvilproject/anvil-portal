...
1. Click on the "**Export All to PFB**" button. Please wait patiently for this step - it can take 30 - 60s - and please do not navigate away while the export is in progress
