...
<Video
  src="https://www.youtube.com/embed/19upPoqNpx0"
  title="Week 6: Reproducible research with AnVILPublish"
/>

<Alert icon={false} severity="info" title="Notes">
  1. Visit the [course
  schedule](/events/bioconductor-popup-workshops-20210531#other-sessions) for
  ...
  Steps](/learn/data-analysts/reproducible-research-with-anvilpublish#next-steps)'
  for how to create a billing account. 1. Access to the workspaces we use may
  require registration; please [sign up](https://forms.gle/HCY2DM2QsuxAwdhv6)
