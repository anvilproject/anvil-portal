...
<Video
  src="https://www.youtube.com/embed/DO6RjmGjIZA"
  title="Week 2: The R / Bioconductor AnVIL package"
/>

<Alert icon={false} severity="info" title="Notes">
  1. Visit the [course
  schedule](/events/bioconductor-popup-workshops-20210503#other-sessions) for
  ...
  Steps](/learn/data-analysts/the-r-bioconductor-anvil-package#next-steps)' for
  how to create a billing account. 1. Access to the workspaces we use may
