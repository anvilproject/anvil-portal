...
<Subheader>Vince Carey</Subheader>
...
<Video
  src="https://www.youtube.com/embed/0LfpVe-MmGE"
  title="Week 4: Single-cell RNASeq with 'Orchestrating Single Cell Analysis' in R / Bioconductor"
/>

<Alert icon={false} severity="info" title="Notes">
  1. The material below requires a billing account. We provide a billing account
  during the workshop, but if you're following along on your own see [Terra
  support](https://support.terra.bio/hc/en-us/articles/360046295092-Claim-300-Google-credits-to-explore-Terra)
  for how to create a billing account. 1. Access to the workspace we use
...
This week introduces a resource, developed primarily by Aaron Lun of Genentech, Inc., that employs Bioconductor resources for many aspects of the analysis of single-cell RNA-seq data. The resource is a "computable book" written in R Markdown, published at [https://bioconductor.org/books/release/OSCA](https://bioconductor.org/books/release/OSCA/).
...
- Expand the 'HAMBURGER' menu (blue circle, below).
  ![Expand Menu](/consortia/learn/data-analysts/analysis-menu.png)
- Click the 'Sign in with Google' icon and follow the prompts.
  ![Sign In With Google](/consortia/learn/data-analysts/analysis-sign-in.png)
...
- AnVIL data and computing resources are organized around Workspaces. Once you've signed, in, choose 'Workspaces' under the HAMBURGER menu.
  ![Choose Workspaces](/consortia/learn/data-analysts/analysis-workspaces-tab.png)
...
- If you registered for the workshop with an email address known to AnVIL / Terra, you'll see the Bioconductor-Workshops-PopUp workspace under 'MY WORKSPACES'.
  ![Bioconductor Workshop](/consortia/learn/data-analysts/analysis-bioconductor-workshop.png)
- Enter the workspace by clicking on the [use-strides/Bioconductor-Workshop-OSCA-3-12](https://app.terra.bio/#workspaces/use-strides/Bioconductor-Workshop-OSCA-3-12) link. There are many components to the workspace; we'll cover many of these over the course of the PopUp workshops.
  ![Enter the Workspace](/consortia/learn/data-analysts/analysis-enter-workspace.png)
- Start by making a _clone_ so that we can perform computations on our own copy of the workspace. Do this by clicking on the TEARDROP (three vertical dots) in the top right of the page, and choose 'Clone'
  ![Start by Making a Clone](/consortia/learn/data-analysts/analysis-clone-menu.png)
- If you see something like the following, then customize the 'Workspace name' to a globally unique name. In a previous workshop, the 'copy' suffix was converted to 'mtmorgan-popup'. It's convenient NOT to have spaces in a workspace name.
  ![Customize Workspace Name](/consortia/learn/data-analysts/analysis-customize-workspace-name.png)
  If instead you see a 'Billing project' that is NOT deeppilots-bioconductor, or if you see something like
  ![Set up Billing Message](/consortia/learn/data-analysts/analysis-billing-message.png)
...
- Return, via the HAMBURGER menu or by clicking on the WORKSPACES element at the top of the page, to the list of WORKSPACES available to you. You'll see your own version of the workspace. Open it.
  ![Open the Cloned Workspace](/consortia/learn/data-analysts/analysis-open-cloned-workspace.png)
...
![Starting RStudio](/consortia/learn/data-analysts/analysis-starting-rstudio.png)

in the upper left corner, and when you click on the "gear" you'll have a widget

![RStudio Widget](/consortia/learn/data-analysts/analysis-rstudio-widget.png)

and you click the CUSTOMIZE button to see

![Customize RStudio](/consortia/learn/data-analysts/analysis-customize-rstudio.png)
...
![Ready to Create](/consortia/learn/data-analysts/analysis-ready-to-create.png)
...
![RStudio Launched](/consortia/learn/data-analysts/analysis-rstudio-launched.png)
...
![Create Project](/consortia/learn/data-analysts/analysis-create-project.png)
...
![Bioconductor](/consortia/learn/data-analysts/analysis-about-bioconductor.png)
...
![Managing Single Cell Data](/consortia/learn/data-analysts/analysis-managing-single-cell-data.png)
...
![SummarizedExperiment](/consortia/learn/data-analysts/analysis-summarized-experiment.png)
...
![Filtering SummarizedExperiment](/consortia/learn/data-analysts/analysis-filtering-summarized-experiment.png)
...
![Mapping Cell Types to Cell Ontology](/consortia/learn/data-analysts/analysis-mapping-cell-types.png)

This just shows the positions in a portion of the Cell Ontology, of the first 20 cell types. See [Appendix 1](/learn/data-analysts/single-cell-rnaseq-with-orchestrating-single-cell-analysis-in-r-bioconductor#appendix-1-sketching-ontological-relationships) for details on how this is done.
