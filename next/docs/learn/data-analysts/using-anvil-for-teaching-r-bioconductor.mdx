...
<Video
  src="https://www.youtube.com/embed/U28gdlVg958"
  title="Week 5: Using AnVIL for teaching R / Bioconductor"
/>

<Alert icon={false} severity="info" title="Notes">
  1. Doing this on your own will require a billing account. We provide a billing
  account during the workshop, but if you're following along on your own see
  '[Set up
  Billing](/learn/data-analysts/using-anvil-for-teaching-r-bioconductor#set-up-billing)'
  for options to create a billing account. 1. Access to the workspace we use
  requires registration; please [sign up](https://forms.gle/HCY2DM2QsuxAwdhv6)
  with your AnVIL email address.
</Alert>
