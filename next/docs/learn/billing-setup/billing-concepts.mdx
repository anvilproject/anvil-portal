...
**Linking GCP and Terra** - To enable GCP spend in Terra, you must add Terra’s Google ID _[terra-billing@terra.bio](mailto:terra-billing@terra.bio)_ as a “_Billing Account User_” to a GCP Billing Account.
