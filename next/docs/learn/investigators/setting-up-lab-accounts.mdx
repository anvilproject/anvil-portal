...
<Figure
  ...
  caption="Figure 1. Adding Terra as a Billing Account User to a Google Billing Account."
  src="/consortia/learn/investigators/link-terra.png"
/>
...
1. Log into Terra manage billing page.
   ...
   <CallToActionButton
     callToAction={{
       label: "Sign in to Terra Manage Billing",
       url: "https://anvil.terra.bio/#billing",
     }}
   />
...
<Figure
  alt="Default budget alert thresholds in Google Cloud."
  caption="Figure 2. Default budget alert thresholds created by GCP on GCP Budget creation."
  src="/consortia/learn/investigators/default-budget-thresholds.png"
/>
...
1. Log in to the Terra workspaces screen.
   ...
   <CallToActionButton
     callToAction={{
       label: "Sign in to Terra Workspaces",
...
<Figure
  alt="Setting Data Analyst workspace permissions."
  caption="Figure 3. Setting Data Analysts workspace permissions to “Writer” with “can-compute”, but disabling sharing."
  src="/consortia/learn/investigators/share-writer-can-compute-no-share.png"
/>
