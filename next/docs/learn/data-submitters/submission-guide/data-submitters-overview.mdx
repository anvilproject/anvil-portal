...
<Figure
  alt="A terra workspace."
  caption="An example of a terra workspace documentation page."
  src="/consortia/learn/data-submitters/terra-workspace.png"
/>
...
Please contact the AnVIL Outreach team with support and training requests at [help@lists.anvilproject.org](mailto:help@lists.anvilproject.org).
