...
<Figure
  alt="Create File"
  caption="Figure 1: Using the github interface to create a new page."
...
<Figure
  alt="Create Folder"
  caption="Figure 2: Using the github interface to create a new folder."
  src="/consortia/guides/create-folder.gif"
/>
