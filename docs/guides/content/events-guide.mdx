...
Once the event has happened please gather any slides, minutes / notes, video recordings., hashtags for posting the [events](/events) page and workshop videos listing. These can be delivered as a pull request to the event's page or as a Google doc.
