---
description: "Overview of data consortia hosted on the AnVIL platform, including current and planned genomic research programs."
...
<Consortia gridSx={{ gap: 4 }}>
  ...
  <Card
    cardActions={[
      {
        label: "Learn More",
        url: isGREGoREnabled ? "/consortia/gregor" : "https://gregorconsortium.org/data",
      },
    ]}
    text={
      <span>
  ...
  <Card
    cardActions={[
      {
        label: "Learn More",
        url: isPRIMEDEnabled ? "/consortia/primed" : "https://primedconsortium.org",
      },
    ]}
    text="The NIH-funded Polygenic Risk Methods Development (PRIMED) Consortium is developing and evaluating methods to improve the use of polygenic risk scores (PRS) to predict disease and health outcomes in diverse ancestry populations."
    title="PRIMED"
  />
  <Card
    cardActions={[
