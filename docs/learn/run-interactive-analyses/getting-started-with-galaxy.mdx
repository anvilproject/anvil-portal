...
title: "Running Galaxy in AnVIL / Terra"
---
...
<Video src="https://www.youtube.com/embed/-Q4SjLEd99s" />

## Launching Galaxy in AnVIL

To access Galaxy use the new "Create a Cloud Environment for Galaxy" feature under Notebooks.

![Create a cloud environment for Galaxy](/consortia/learn/interactive-analysis/galaxy-cloud-environment-create.png)

This will take you to the AnVIL branded version of Galaxy!

![AnVIL branded Galaxy](/consortia/learn/interactive-analysis/galaxy-anvil-branded-galaxy.png)
...
![Browsing files in the AnVIL/Terra Workspace](/consortia/learn/interactive-analysis/galaxy-browsing-files.png)

![bcftools](/consortia/learn/interactive-analysis/galaxy-bcf-tools.png)
...
1. To access it, visit the [AnVIL portal](/) and click on "Launch Terra".
   ![Step 1](/consortia/learn/interactive-analysis/galaxy-step-1.png)
1. This will take you to the Terra sign in page, which allows you to sign in using your Google credentials.
   ![Step 2](/consortia/learn/interactive-analysis/galaxy-step-2.png)
1. If you plan to work with controlled-access data, you should first link your NIH Researcher Authentication Service (RAS) identity to your AnVIL/Terra account from [the External Identities tab of your profile](https://anvil.terra.bio/#profile?tab=externalIdentities). Select "Log In To RAS" and sign in using the Login.gov or ID.me account linked to your eRA Commons identity. For step-by-step instructions, see [Requesting Data Access](/learn/find-data/requesting-data-access#step-4-link-your-nih-ras-identity-in-terra).
1. After signing in, confirm that your NIH RAS identity appears under External Identities. Note that once per month, you will need to relink these accounts to ensure that you still have proper access.
1. Once your accounts are linked, return to the workspace list available at https://anvil.terra.bio/#workspaces.
   ![Step 5](/consortia/learn/interactive-analysis/galaxy-step-5.png)
1. Galaxy must be launched from a workspace. This can either be an existing workspace that has data already loaded, or could be from a new workspace. For this example, we will create a new workspace using the "Create New Workspace" dialog. Note you will also need to set up and select a Billing project to be associated with the Workspace.
   ![Step 6](/consortia/learn/interactive-analysis/galaxy-step-6.png)
1. For this example, we will load (simulated) microbial sequencing data available here: <a href="./_files/asm.tgz" download>asm.tgz</a>. After downloading the asm.tgz file, expand the archive and upload the data to the Terra workspace by dragging and dropping the files from your local computer (or using the + button) into the Files pane in the Data tab.
   ![Step 7](/consortia/learn/interactive-analysis/galaxy-step-7.png)
   ![Step 7 - loaded](/consortia/learn/interactive-analysis/galaxy-step-7a.png)
1. Next click on the "Notebooks" tab to find the "Create a Cloud Environment for Galaxy" button.
   ![Step 8](/consortia/learn/interactive-analysis/galaxy-step-8.png)
1. Clicking on the "Create a Cloud Environment for Galaxy’ button brings up the "Cloud environment" launch panel.
   ![Step 9](/consortia/learn/interactive-analysis/galaxy-cloud-environment-create.png)
1. Clicking next then shows the "Create" panel.
   ![Step 10](/consortia/learn/interactive-analysis/galaxy-step-10.png)
1. After clicking "Create" you will see a new icon at the top showing "Galaxy Provisioning". It will take approximately 10 minutes for Galaxy to be fully provisioned and initialized.
   ![Step 11](/consortia/learn/interactive-analysis/galaxy-step-11.png)
1. After provisioning, you will be notified that you can now launch Galaxy.
   ![Step 12](/consortia/learn/interactive-analysis/galaxy-step-12.png)

### II. Welcome to Galaxy in AnVIL

13. Clicking "Launch Galaxy" will take you to the Galaxy welcome screen.
    ![Step 13](/consortia/learn/interactive-analysis/galaxy-anvil-branded-galaxy.png)
1. Click on the data upload tool to load your data into Galaxy.
   ![Step 14](/consortia/learn/interactive-analysis/galaxy-step-14.png)
1. This will display the data browser.
   ![Step 15](/consortia/learn/interactive-analysis/galaxy-step-15.png)
1. Then click "Choose remote files" to access your AnVIL/Terra Workspace.
   ![Step 16](/consortia/learn/interactive-analysis/galaxy-step-16.png)
1. Browse inside your workspace to "Other Data".
   ![Step 17](/consortia/learn/interactive-analysis/galaxy-step-17.png)
1. And then "Files/".
   ![Step 18](/consortia/learn/interactive-analysis/galaxy-step-18.png)
1. Here you will see all of the data you loaded into your AnVIL Workspace.
   ![Step 19](/consortia/learn/interactive-analysis/galaxy-browsing-files.png)
1. Select all of the files to load into Galaxy.
   ![Step 20](/consortia/learn/interactive-analysis/galaxy-step-20.png)
1. Clicking "Ok" will finalize the selection.
   ![Step 21](/consortia/learn/interactive-analysis/galaxy-step-21.png)
1. After clicking "Start" the data will be transferred into Galaxy.
   ![Step 22](/consortia/learn/interactive-analysis/galaxy-step-22.png)
1. You can then "Close" the data picker to see the main Galaxy interface.
   ![Step 23](/consortia/learn/interactive-analysis/galaxy-step-23.png)
...
24. On the left-hand tool panel, expand the "FASTQ Quality Control" menu and click on "FastQC". This will automatically pick the most recent item in your history (frag180.1.fq).
    ![Step 24](/consortia/learn/interactive-analysis/galaxy-step-24.png)
1. Clicking "Execute" at the bottom of this panel will run the tool.
   ![Step 25](/consortia/learn/interactive-analysis/galaxy-step-25.png)
1. As the Job is running, the task will be added to the history panel on the right.
   ![Step 26](/consortia/learn/interactive-analysis/galaxy-step-26.png)
1. Once the job is complete you will see the job turn green.
   ![Step 27](/consortia/learn/interactive-analysis/galaxy-step-27.png)
1. Click the "Eye" view data tool to show the results.
   ![Step 28](/consortia/learn/interactive-analysis/galaxy-step-28.png)
1. This shows the reads have overall good quality, with a decrease trend over the read length (as expected).
   ![Step 29](/consortia/learn/interactive-analysis/galaxy-step-29.png)
1. Next align the reads with Bowtie2. Make sure to select paired-end reads, fastq #1 should be "frag180.1.fq" and fastq #2 should be "frag180.2.fq".
   ![Step 30](/consortia/learn/interactive-analysis/galaxy-step-30.png)
1. Then pick "ref.fa" as your reference genome.
   ![Step 31](/consortia/learn/interactive-analysis/galaxy-step-31.png)
1. Clicking "Execute" will show Bowtie2 launching.
   ![Step 32](/consortia/learn/interactive-analysis/galaxy-step-32.png)
1. Next use the plotCoverage tool to display the coverage histogram. Note the results from Bowtie2 will automatically be selected since that is the only compatible file format.
   ![Step 33](/consortia/learn/interactive-analysis/galaxy-step-33.png)
1. Click "Execute" to show plotCoverage running.
   ![Step 34](/consortia/learn/interactive-analysis/galaxy-step-34.png)
1. Once complete, click the view data icon for the plotCoverage image (step 9) to show the coverage distribution.
   ![Step 35](/consortia/learn/interactive-analysis/galaxy-step-35.png)
...
40. When you are done with Galaxy, you will need to stop your running instance of Galaxy to stop the charges. Return to the AnVIL workspace where you launched Galaxy.
    ![Step 40](/consortia/learn/interactive-analysis/galaxy-step-40.png)
1. Click "Galaxy Running" to display the administrative panel.
   ![Step 41](/consortia/learn/interactive-analysis/galaxy-step-41.png)
1. Click "Delete" to stop and delete your Galaxy instance. Note this will delete all data and results files from your Galaxy session.
   ![Step 42](/consortia/learn/interactive-analysis/galaxy-step-42.png)
1. After your running version of Galaxy is done, the "Galaxy Running" icon will disappear.
   ![Step 43](/consortia/learn/interactive-analysis/galaxy-step-43.png)
