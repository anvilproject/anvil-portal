...
<Alert icon={false} severity="info">
  ...
  1. Doing this on your own will require a billing account. We provide a billing account during the workshop, but if you're following along on your own see '[Set up Billing](/learn/run-interactive-analyses/using-anvil-for-teaching-r-bioconductor#set-up-billing)' for options to create a billing account.
