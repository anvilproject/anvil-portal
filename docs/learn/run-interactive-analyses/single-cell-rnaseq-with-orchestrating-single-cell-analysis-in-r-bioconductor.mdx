...
This just shows the positions in a portion of the Cell Ontology, of the first 20 cell types. See [Appendix 1](/learn/run-interactive-analyses/single-cell-rnaseq-with-orchestrating-single-cell-analysis-in-r-bioconductor#appendix-1-sketching-ontological-relationships) for details on how this is done.
