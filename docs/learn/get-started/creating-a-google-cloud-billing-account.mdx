...
1. Decide what email address to use. The email you choose must be associated with a Google ID (see [Obtaining a Google ID](/learn/get-started/obtaining-a-google-id)) and must be the email you will use to log in to Terra.
