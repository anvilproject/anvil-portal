...
### Before you apply
Note that you will need the **phsID** from **dbGaP** (step 1.2 above) and **Access Restrictions** (i.e., Data Use limitations/consent groups) to complete the application.
