...
As you get started, we recommend you review the AnVIL Data Model Data Dictionary [here](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1695394730#gid=1695394730) to learn more about the general structure (which we will describe in more detail below). You’ll coordinate with the AnVIL data ingest team to facilitate submission activities. 
...
We encourage you to read the [README](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1482408180#gid=1482408180) and [AnVIL Table Overview](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1382632748#gid=1382632748) tabs in the AnVIL Data Model data dictionary as you begin creating your AnVIL Data Model.  
...
* [**BioSample**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1695394730#gid=1695394730) **(required):** Contains information about the sample(s) included in the study.  Example data types include Anatomical Site from which the biosample was taken and the cell type.  
...
* [**Donor**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1811136544#gid=1811136544) **(strongly recommended):** Contains demographic and phenotypic information about the donor. Example data types include phenotypic sex, reported ethnicity, and genetic ancestry.  
  * The `donor_id` (first column) is required.   
* [**File**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1157757819#gid=1157757819) **(strongly recommended):** Contains information for files associated with the study. Example data includes DRS ID, filename, and file type.  
...
* [**Condition Table:**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1768340842#gid=1768340842) Contains information about condition(s) and phenotypes associated with a donor.   
...
* [**Activity Table:**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=2117817307#gid=2117817307) Contains details on different types of activities used to generate or process data. Example data includes sequencing method, reference assembly, and assay type.   
  * The `activity_id` (first column) is required.   
  * Should include a `file_id` column that references the associated file.   
* [**Project Table:**](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1027670832#gid=1027670832) Contains information about the project the study is a part of. Example data includes funding, and principal investigator. It is strongly recommended that the table includes a title field.  
  * The `project_id` (first column) is required. 

#### Non-standard Data Models

If your dataset has been accepted by AnVIL and has needs not described here, please refer to the README on “[Expanding the data model](https://docs.google.com/spreadsheets/d/16gik9Y1mWqOo6DAlFu1ygFGb3XVgTzOz/edit?gid=1482408180#gid=1482408180&range=B16)”. Additional tables must be associated with one of the core tables: BioSample, Donor, or File. If you need further assistance, please reach out to the AnVIL Team at help@lists.anvilproject.org. You can work directly with the AnVIL Phenotype WG and Data Ingest WG to integrate into one of these existing data models.
...
| Donor | Donor type | [Donor type values](https://docs.google.com/spreadsheets/d/1BL4PIZxp2NvqGdaWIZouedsA_pAr5SXA/edit?gid=157714525#gid=157714525&range=C1:C3) |
| Donor | Phenotype sex code | [Phenotype sex coding system](https://docs.google.com/spreadsheets/d/1BL4PIZxp2NvqGdaWIZouedsA_pAr5SXA/edit?gid=157714525#rangeid=1477557223) |
...
| Donor | Reported ethnicity coding system, Genetic ancestry coding system | [Genetic ancestry coding system](https://docs.google.com/spreadsheets/d/1BL4PIZxp2NvqGdaWIZouedsA_pAr5SXA/edit?gid=157714525#rangeid=819609887) |
| BioSample | Anatomical site label | [Anatomical Site Allowed Values](http://purl.obolibrary.org/obo/FMA_62955) |
| BioSample | Anatomical site coding system | [Anatomical site coding system](https://docs.google.com/spreadsheets/d/1OE4XqK43h0yurZ1X0mhwi8iiJSpE4hzb/edit?gid=157714525#rangeid=271391259) |
| BioSample | A priori cell type label | [A priori cell type suggested values](http://purl.obolibrary.org/obo/CL_0000000) |
| BioSample | A priori cell type coding system | [A priori cell type](https://docs.google.com/spreadsheets/d/1OE4XqK43h0yurZ1X0mhwi8iiJSpE4hzb/edit?gid=157714525#rangeid=1366269516) |
| BioSample | BioSample type label | [BioSample type values](https://docs.google.com/spreadsheets/d/1OE4XqK43h0yurZ1X0mhwi8iiJSpE4hzb/edit?gid=157714525#gid=157714525&range=A:A) |
| BioSample | BioSample type coding system | [BioCore Terms](https://docs.google.com/spreadsheets/d/1OE4XqK43h0yurZ1X0mhwi8iiJSpE4hzb/edit?gid=157714525#gid=157714525&range=A:A) |
...
| Activity | Activity type label | [Activity type values](https://docs.google.com/spreadsheets/d/1OE4XqK43h0yurZ1X0mhwi8iiJSpE4hzb/edit?gid=157714525#rangeid=1923950114) |
