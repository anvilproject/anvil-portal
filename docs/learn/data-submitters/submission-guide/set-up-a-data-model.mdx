...
* [AnVIL Findability Subset Data Model](https://anvilproject.org/learn/data-submitters/submission-guide/set-up-a-data-model#23-generate-your-data-dictionary)   
* [GREGoR Data Model](https://gregorconsortium.org/data-model)  
* [OMOP Common Data Model](#222---omop-common-data-model)  
...
* Submit your OMOP tables as tsv files  
  * Provide these minimum required OMOP Domain tables: Person, Death, Visit\_Occurrence, Visit\_Detail, Condition\_Occurrence, Drug\_Exposure, Procedure\_Occurrence, Device\_Exposure, Measurement, Observation, Specimen  
