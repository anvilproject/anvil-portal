...
<Alert icon={false} severity="info">
  ...
  1. The material below requires a billing account. We provide a billing account during the workshop, but if you're following along on your own see '[Next Steps](/learn/interactive-analysis/reproducible-research-with-anvilpublish#next-steps)' for how to create a billing account.
