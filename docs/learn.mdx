...
To send artificial cohorts from  to Terra for Analysis, you will need to use the same Google ID for your Data Explorer and Terra accounts.
...
<Alert icon={false} severity="info">
  For instructions on setting up accounts in Google, Terra, the AnVIL Data Exlplorer, and linking
...
be accessed in Terra or teh Data Explorer immediately after account creation.
...
<Alert severity="warning">
  Note that workspace billing charges flow through to the workspaces Terra
