...
featured: true
sessions:
  [{ sessionEnd: "26 Apr 2021 1:00 PM", sessionStart: "26 Apr 2021 12:00 PM" }]
...
For a tutorial based on the workshop with an accompanying tutorial see [Using R / Bioconductor in AnVIL](/learn/run-interactive-analyses/using-r-bioconductor-in-anvil).
...
| Date                  | Topic                                                                        |
| :-------------------- | :--------------------------------------------------------------------------- |
| <nobr>April 26</nobr> | [Using R / Bioconductor in AnVIL][4] (Martin Morgan) [[recorded session][5]] |

## Other Sessions

| Date                       | Topic                                                                                                                                            |
| :------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- |
| <nobr>[May 3][6]</nobr>    | The R / Bioconductor AnVIL package for easy access to buckets, data, and workflows, and fast package installation (Martin Morgan, Nitesh Turaga) |
