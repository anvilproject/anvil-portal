...
For a tutorial based on the workshop with an accompanying tutorial see [Running a Workflow: Bulk RNASeq Differential Expression from FASTQ Files to Top Table](/learn/interactive-analysis/running-a-workflow).
