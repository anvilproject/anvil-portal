...
For a tutorial based on the workshop with an accompanying tutorial see [Running a Workflow: Bulk RNASeq Differential Expression from FASTQ Files to Top Table](/learn/run-interactive-analyses/running-a-workflow).
...
| Date                | Topic                                                                                                                    |
| :------------------ | :----------------------------------------------------------------------------------------------------------------------- |
| <nobr>May 10</nobr> | Running a workflow: Bulk RNASeq differential expression from FASTQ files to top table (Martin Morgan, Kayla Interdonato) |
