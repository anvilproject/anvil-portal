...
featured: true
sessions:
  [{ sessionEnd: "31 May 2021 1:00 PM", sessionStart: "31 May 2021 12:00 PM" }]
...
For a tutorial based on the workshop with an accompanying tutorial see [Reproducible research with AnVILPublish](/learn/run-interactive-analyses/reproducible-research-with-anvilpublish).
...
| Date                | Topic                                                   |
| :------------------ | :------------------------------------------------------ |
| <nobr>May 31</nobr> | Reproducible research with AnVILPublish (Martin Morgan) |
...
| <nobr>[May 17][9]</nobr>   | Single-cell RNASeq with 'Orchestrating Single Cell Analysis' in R / Bioconductor (Vince Carey)                                                   |
| <nobr>[May 24][10]</nobr>  | Using AnVIL for teaching R / Bioconductor (Levi Waldron)                                                                                         |
