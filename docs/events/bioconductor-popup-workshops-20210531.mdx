...
For a tutorial based on the workshop with an accompanying tutorial see [Reproducible research with AnVILPublish](/learn/interactive-analysis/reproducible-research-with-anvilpublish).
