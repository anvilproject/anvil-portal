...
For a tutorial based on the workshop with an accompanying tutorial see [Single-cell RNASeq with 'Orchestrating Single Cell Analysis' in R / Bioconductor](/learn/interactive-analysis/single-cell-rnaseq-with-orchestrating-single-cell-analysis-in-r-bioconductor).
