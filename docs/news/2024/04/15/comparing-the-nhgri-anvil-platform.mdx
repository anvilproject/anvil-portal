...
<Alert icon={false} severity="info">
  For new users to AnVIL, you can learn more about the platform and its
  offerings at [anvilproject.org/learn](/learn). If you have any questions, feel
  free to engage with us at [help.anvilproject.org]({anvilHelpURL}).
</Alert>
...
- Discover datasets stored in AnVIL with the [AnVIL Data Explorer]({browserURL}/datasets).
- Learn [how to apply for access to NHGRI controlled-access datasets](/learn/find-data/requesting-data-access).
...
- [Preparing a Cloud Cost Budget Justification](/learn/control-cloud-costs/budget-templates)
