...
<Alert severity="warning">
  Starting October 1, 2024, the AnVIL Gen3 Commons and free downloadable version of GTEx v8 through Gen3 will be decommissioned. Please see [Sunsetting Gen3 Functionality in AnVIL](/news/2024/09/16/sunsetting-gen3-in-anvil) for more information. For step-by-step instructions on downloading GTEx data, see [How to download GTEx data to Terra - option 2: download to local machine](https://support.terra.bio/hc/en-us/articles/30873545719451-How-to-access-GTEx-data-in-Terra#h_01JE9G5KQ1Y4M6VNQCPE90QDZS). **Note that you may incur egress fees when downloading GTEx data.** 
</Alert>
