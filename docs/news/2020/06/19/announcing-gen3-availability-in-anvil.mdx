...
<Alert severity="warning">
    Starting October 1, 2024, AnVIL Gen3 will be decommissioned. Please see [Sunsetting Gen3 Functionality in AnVIL](https://anvilproject.org/news/2024/09/16/sunsetting-gen3-in-anvil) for more information.
</Alert>
...
Researchers may visit [https://gen3.theanvil.io/](https://gen3.theanvil.io/) to explore AnVIL's Gen3 indexed datasets, create virtual cohorts in the Gen3 Data Explorer and export them to [AnVIL's Terra instance](https://anvil.terra.bio/#workspaces) for analysis.

![Gen3](/consortia/news/gen3-noshadow.png)
