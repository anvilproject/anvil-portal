...
- Over 3,000 bulk whole genome bisulfite genome sequences for methylome interpretation
...
Access requests for this controlled data are available through dbGaP under accession [phs002206.v5.p1](https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=phs002206.v5.p1) and the data is available at https://explore.anvilproject.org/datasets or https://duos.org/datalibrary/anvil.
