...
AnVIL employs robust access controls that can selectively grant access to one or more datasets depending on each user’s access approvals. More information on Access Controls in AnVIL can be found [here](https://docs.google.com/document/d/1VX_tV_VtqkDdBjLIFYELjQK12YcJljzGVlXSKgJYdI8/preview).
...
- dbGaP Data Access Request - Members of the wider community may request access through dbGaP. Upon receiving approval for access in dbGaP, the researcher will be able to access the data within the AnVIL. You can [reference AnVIL](/overview/security#cloud-use-statement) in your access request.
...
## Does AnVIL release information about User Accounts to NIH or other federal agencies?

As per the [Terra Terms of Services](https://terra.bio/terms-of-service/) and the [Terra Privacy Policy](https://app.terra.bio/#privacy), AnVIL monitors User Accounts. Since AnVIL is supported by Federal funding from NIH, AnVIL may be directed by NIH to provide any records pertinent to the Federal award, including User Access Logs, to perform audits or for any other official use.
