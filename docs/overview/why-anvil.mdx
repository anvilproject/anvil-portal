...
![A workspace can be a shareable record of analyses. An example workspace is shown with options to share the workspace through its permalink highlighted](/consortia/overview/images/why_anvil_workspace_share.png)
...
![The general benefits of using the AnVIL are shown. These include the ability to control costs, work with protected data safely, maintenance is handled, training and support is available, and there is a collaborative community](/consortia/overview/images/why_anvil_general_benefits_outline.png)
